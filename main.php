...
<p>&nbsp;</p>
<p align="center" style="font-size:16px;font-weight:bold;">Welcome to Smart Kitchen System</p>
...
<div class="catBox">
<img src="<?php echo WEB_ROOT; ?>images/slowConsume.png"  class="cImage" />
<a href="<?php echo WEB_ROOT; ?>menu.php?v=HRWR">SlowConsume Details</a>
...
<div class="catBox">
<img src="<?php echo WEB_ROOT; ?>images/fastConsume.png"  height="36" width="36" class="cImage" />
<a href="<?php echo WEB_ROOT; ?>menu.php?v=SFWR">FastConsume Details</a>
...
<p>View the list of an admin user(s). An admin can create an admin, sub-admin. sub-admin can't create an admin, or sub-admin. Access previledge is given to all the roles with responsibility.</p>
</div>
